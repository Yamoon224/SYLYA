            ...
            <div class="row">
                <div class="col-lg-3 widget-area sidebar-left">
                    ...
                    <aside class="widget widget_media_image banner-image">
                        <a href="#"><img class="img-fluid" src="{{ asset('images/widget-banner-three.jpg') }}" alt="widget-banner"></a>
                    </aside>
                </div>
                                    ...
                                    <div class="products row">
                                        ...
                                        <div class="product col-md-3 col-sm-6 col-xs-12">
                                            <div class="product-box">
                                                ...
                                                <div class="product-box-inner">
                                                    <div class="product-image-box">
                                                        <img class="img-fluid pro-image-front" src="{{ asset('images/product/pro-back-01.png') }}" alt="">
                                                        <img class="img-fluid pro-image-back" src="{{ asset('images/product/pro-front-01.png') }}" alt="">
                                                    </div>
                                                    <div class="product-btn-links-wrapper">
                                                        <div class="product-btn"><a href="#" class="add-to-cart-btn tooltip-top" data-tooltip="Add To Cart"><i class="ti ti-shopping-cart"></i></a>
                                                        </div>
                                        ...
                                        <div class="product col-md-3 col-sm-6 col-xs-12">
                                            <div class="product-box">
                                                ...
                                                <div class="product-box-inner">
                                                    <div class="product-image-box">
                                                        <div class="onsale">Sale!</div>
                                                        <img class="img-fluid pro-image-front" src="{{ asset('images/product/pro-back-06.png') }}" alt="">
                                                        <img class="img-fluid pro-image-back" src="{{ asset('images/product/pro-front-06.png') }}" alt="">
                                                    </div>
                                                    <div class="product-btn-links-wrapper">
                                                        <div class="product-btn"><a href="#" class="add-to-cart-btn tooltip-top" data-tooltip="Add To Cart"><i class="ti ti-shopping-cart"></i></a>
                                                        </div>
                                    ...
                                    <div class="products row">
                                        ...
                                        <div class="product col-md-3 col-sm-6 col-xs-12">
                                            <div class="product-box">
                                                ...
                                                <div class="product-box-inner">
                                                    <div class="product-image-box">
                                                        <img class="img-fluid pro-image-front" src="{{ asset('images/product/pro-back-10.png') }}" alt="">
                                                        <img class="img-fluid pro-image-back" src="{{ asset('images/product/pro-front-10.png') }}" alt="">
                                                    </div>
                                                    <div class="product-btn-links-wrapper">
                                                        <div class="product-btn"><a href="#" class="add-to-cart-btn tooltip-top" data-tooltip="Add To Cart"><i class="ti ti-shopping-cart"></i></a>
                                                        </div>
